...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/oscarmanriquemartinez/BlinkingLabel'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'oscarmanriquemartinez' => 'oscar.manrique@vass.es' }
  s.source           = { :git => 'https://github.com/oscarmanriquemartinez/BlinkingLabel.git', :tag => s.version.to_s }
